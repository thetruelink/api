...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'data.amqp' => 'getData_AmqpService',
            'data.data_provider' => 'getData_DataProviderService',
            'data.validator' => 'getData_ValidatorService',
     ...
     * This method always returns the same instance of the service.
     *
     * @return \DataBundle\Service\JwtAuthenticator A DataBundle\Service\JwtAuthenticator instance
     */
    protected function getApp_JwtTokenAuthenticatorService()
    {
        return $this->services['app.jwt_token_authenticator'] = new \DataBundle\Service\JwtAuthenticator($this->get('doctrine.orm.default_entity_manager'), $this->get('lexik_jwt_authentication.encoder.default'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('A1D-c+qXI9', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5SqWKm0rI8', 0, 'c55tPbPOAYyfRwKQZhAEBE', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    /*
     * Gets the 'data.amqp' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \DataBundle\Rabbitmq\RbmqProvider A DataBundle\Rabbitmq\RbmqProvider instance
     */
    protected function getData_AmqpService()
    {
        return $this->services['data.amqp'] = new \DataBundle\Rabbitmq\RbmqProvider();
    }

    /*
     * Gets the 'data.data_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \DataBundle\Http\DataProvider A DataBundle\Http\DataProvider instance
     */
    protected function getData_DataProviderService()
    {
        return $this->services['data.data_provider'] = new \DataBundle\Http\DataProvider($this->get('doctrine.orm.default_entity_manager'), $this->get('data.validator'), $this);
    }

    /*
     * Gets the 'data.validator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \DataBundle\Http\RequestValidation A DataBundle\Http\RequestValidation instance
     */
    protected function getData_ValidatorService()
    {
        return $this->services['data.validator'] = new \DataBundle\Http\RequestValidation($this->get('doctrine.orm.default_entity_manager'), $this);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'symfony', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'unix_socket' => '/Applications/MAMP/tmp/mysql/mysql.sock', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_6ace6f7e4ced210fa31afd9b6686817942baab91698824ac72777f34b5b11079');
    ...
    {
        return $this->services['lexik_jwt_authentication.key_loader'] = new \Lexik\Bundle\JWTAuthenticationBundle\Services\KeyLoader\OpenSSLKeyLoader(($this->targetDirs[3].'\\app/../var/jwt/private.pem'), ($this->targetDirs[3].'\\app/../var/jwt/public.pem'), 'truelink');
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/trueLink/crediantialCheck'), 'security.firewall.map.context.api' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/trueLink'), 'security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.main' => NULL)), $this->get('event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_ApiService()
    {
        ...
        return $this->services['security.firewall.map.context.api'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'api', $b, $this->get('event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE), $c), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5a1afc9077b026.49390714', $b, $this->get('security.authentication.manager')), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $c, $this->get('security.http_utils'), 'api', NULL, NULL, NULL, $b, false));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_LoginService()
    {
        ...
        return $this->services['security.firewall.map.context.login'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5a1afc9077b026.49390714', $b, $this->get('security.authentication.manager')), 2 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'login', NULL, NULL, NULL, $b, true));
    }
    ...
    {
        return $this->services['serializer'] = new \Symfony\Component\Serializer\Serializer(array(0 => new \Symfony\Component\Serializer\Normalizer\GetSetMethodNormalizer(), 1 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(), 2 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 3 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(), 4 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 5 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(new \Symfony\Component\Serializer\Mapping\Factory\CacheClassMetadataFactory(new \Symfony\Component\Serializer\Mapping\Factory\ClassMetadataFactory(new \Symfony\Component\Serializer\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Serializer\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')))), NULL), $this->get('cache.serializer')), NULL, $this->get('property_accessor'), NULL)), array(0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => new \Symfony\Component\Serializer\Encoder\JsonEncoder()));
    }
    ...
    {
        return $this->services['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EhQeu8oN5b', 0, 'c55tPbPOAYyfRwKQZhAEBE', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oOolDKd9SF', 0, 'c55tPbPOAYyfRwKQZhAEBE', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('/token-authentication'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'validator.mapping.cache.prefix' => 'validator_7538ce19f18d95259b68a7c0d9f70cf7c65979b31b8dcb8c2e4c41205d0379c0',
            ...
            'lexik_jwt_authentication.pass_phrase' => 'truelink',
