 ...
 */
class Message extends \DataBundle\Entity\Message implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DataBundle\\Entity\\Message' . "\0" . 'id', '' . "\0" . 'DataBundle\\Entity\\Message' . "\0" . 'texte', '' . "\0" . 'DataBundle\\Entity\\Message' . "\0" . 'date', '' . "\0" . 'DataBundle\\Entity\\Message' . "\0" . 'user', '' . "\0" . 'DataBundle\\Entity\\Message' . "\0" . 'contact'];
        }
